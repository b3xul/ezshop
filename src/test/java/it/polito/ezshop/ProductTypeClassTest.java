...
public class ProductTypeClassTest {
	...
	public void testCase1() {
		...
		assertTrue((product.getProductDescription() == "description") && (product.getBarCode() == "12637482635892")
				&& (product.getPricePerUnit() == 2.5) && (product.getNote() == "note"));
	...
	public void testCase4() {
		...
		assertTrue(product.getBarCode().equals("06253478956438"));
